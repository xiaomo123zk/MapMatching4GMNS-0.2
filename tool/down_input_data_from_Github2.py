...
def first_way():
    ...
    # https://github.com/asu-trans-ai-lab/osm_test_data_set/tree/main/datasets/map_matching

    url = 'https://raw.githubusercontent.com/asu-trans-ai-lab/osm_test_data_set/master/'
